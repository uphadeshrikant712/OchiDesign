...
function Footer() {
  return (
    <div className="w-full bg-slate-100 flex p-[1vw] text-black">
      <div className="w-1/2 px-[4vw] relative">
        <h1 className='text-[9vw] font-semibold font-["Founders_Grotesk_x"]  -mb-[6vw]'>
          EYE-
        </h1>
        <h1 className="text-[9vw] font-semibold text-black font-['Founders_Grotesk_X_Condensed']  ">
          OPENING
        </h1>
        <div className="logo p-[4vw] absolute left-0 bottom-0 ">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
      ...
      <div className="w-1/2 h-full ">
        <div className="presentation">
          <h1 className="font-semibold font-['Founders_Grotesk_x']  text-[9vw] uppercase ">
            presentations
          </h1>
        </div>
        <div className="s-section flex flex-col ">
          <div className="heading text-[1.5vw]">S:</div>
        ...
        <div className="l-m-section w-full flex justify-between items-center">
          <div className="l-section flex flex-col gap-[1vw]">
            <div className="heading text-[1.5vw]  ">L:</div>
            <div className="links flex flex-col gap-[1vw]">
              <div className="link1 flex flex-col">
              ...
              <div className="link2 flex flex-col">
                <a href="#"  className="border-b-[1px] border-black">
                  30 Chukarina St
                </a>
                <a href="#"  className="border-b-[1px] border-black">
          ...
          <div className="m-section px-[8vw] ">
            <div className="heading text-[1.5vw] ">M:</div>
            <div className="links flex flex-col">
              <a href="" className="border-b-[1px] border-black">
                Home
              </a>
        ...
        <div className="lastPart font-['gilroy'] flex justify-between mr-[2vw] mt-[2.5vw] opacity-[.3]">
          <div className="terms flex gap-[.5vw]">
            <h1>© ochi design 2024.</h1>
            <a href="#" className="border-b-[1px] border-black">
              Legal Terms
            </a>
          </div>
          <div className="developer">Website by Obys</div>
        </div>
      </div>
    </div>
  );
